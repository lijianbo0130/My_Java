...
public class SimHash_Old {
    ...
    public SimHash_Old(String tokens) throws IOException {
        this.tokens = tokens;
        this.intSimHash = this.simHash();
    }
 
    public SimHash_Old(String tokens, int hashbits) throws IOException {
        this.tokens = tokens;
    ...
    public int hammingDistance(SimHash_Old other) {
    ...
    public List subByDistance(SimHash_Old simHash, int distance) {
        // 分成几组来检查
    ...
    public static void main(String[] args) throws IOException {
        String s ="我的";
        SimHash_Old hash1 = new SimHash_Old(s, 64);
        ...
        // 删除首句话，并加入两个干扰串
        s = "我的";
        SimHash_Old hash2 = new SimHash_Old(s, 64);
        ...
        SimHash_Old hash3 = new SimHash_Old(s, 64);
